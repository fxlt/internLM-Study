...
1. 高质量token训练，建立强大知识库
2. 支持8k token的上下文窗口长度


### 1.2Lagent智能体

智能体框架架构如下：
![Alt text](images/image_2_0.png)

### 1.3InternLM-XComposer灵笔图文创作Demo

灵笔是基于书生浦语大模型研发的视觉-语言大模型：

1.为用户打造图文并茂的专属文章

2.注入了海量多模态概念和知识数据，赋予其强大的图文理解和对话能力
...
![Alt text](images/image_2_10.png)
...
![Alt text](images/image_2_11.png)
...
![Alt text](images/image_2_12.png)

接下来，我们可以体验一下图片理解的能力，如下所示~

![Alt text](images/image_2_13.png)
...
ssh-keygen -t rsa
```
![Alt text](images/image_2_14.png)
...
![Alt text](images/image_2_15.png)

步骤④：将公钥复制到剪贴板中，然后回到 `InternStudio` 控制台，点击配置 SSH Key。如下图所示：

![Alt text](images/image_2_16.png)

步骤⑤：将刚刚复制的公钥添加进入即可。

![Alt text](images/image_2_17.png)
...
![Alt text](images/image_2_18.png)
